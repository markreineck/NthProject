...
insert into orgstatus (statusid, name) values (1, 'Inactive');
insert into orgstatus (statusid, name) values (2, 'Active');

insert into userstatus (statusid, paytype, name) values (1, null, 'Inactive');
insert into userstatus (statusid, paytype, name) values (2, null, 'Active');

insert into taskstatus (statusid, hold, name) values (1, null, 'Waiting');
insert into taskstatus (statusid, hold, name) values (2, 1, 'Hold');
