...
define('SW_PROJECT_TITLE', 'NthProject');
...
define('SW_DB_USER', 'dbo431546522');
define('SW_DB_PASSWORD', 'Hgedr435g*');
define('SW_DB_HOST', 'db431546522.db.1and1.com');
define('SW_DB_DATABASE', 'db431546522');
}
